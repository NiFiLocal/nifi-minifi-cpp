...
function(createTests testName)
   message ("-- Adding test: ${testName}")
    ...
    target_include_directories(${testName} BEFORE PRIVATE "${CMAKE_SOURCE_DIR}/thirdparty/rapidjson-1.1.0/include")
    ...
    target_link_libraries(${testName} ${CMAKE_THREAD_LIBS_INIT} ${OPENSSL_LIBRARIES} core-minifi yaml-cpp dl)
    if (APPLE)
